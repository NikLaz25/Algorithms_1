    ...
    def insert(self, afterNode, newNode):
        ...
        if afterNode is not None:  # вставка после определенного значения
            while node is not None:
                last_node = node
                node = node.next
                if last_node.value == afterNode.value and last_node != self.tail: #когда нашли afterNode и когда он не последний
                    newNode.next = last_node.next
                    last_node.next = newNode
                    return
                if last_node.value == afterNode.value and last_node == self.tail: #когда нашли afterNode и он последний
                    newNode.next = last_node.next
                    last_node.next = newNode
                    self.tail = newNode
                    return
